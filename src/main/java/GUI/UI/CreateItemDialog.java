...
public class CreateItemDialog extends javax.swing.JDialog {
    ...
    public CreateItemDialog(java.awt.Frame parent, boolean modal, boolean isInstrument) {
        super(parent, modal);
        initComponents();
        TitleLabel.putClientProperty("FlatLaf.styleClass", "h1");
        if (!isInstrument) {
            TitleLabel.setText("Crear Accesorio");
        }
    }
    ...
    private void initComponents() {
        ...
        TitleLabel.setText("Crear Instrumento");
