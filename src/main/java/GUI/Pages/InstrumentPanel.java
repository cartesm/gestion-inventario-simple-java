...
public class InstrumentPanel extends javax.swing.JPanel {
    ...
    public InstrumentPanel() {
        ...
        initComponents();
        excelService.populate("infoInstrumentos", InstrumentTable);
    ...
    private void CreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateButtonActionPerformed
        MessageError.setText("");
        CreateItemDialog window = new CreateItemDialog(null, true, true);

        window.setLocationRelativeTo(this);
        window.setTitle("Crear Instrumento");
        ...
        DefaultTableModel table = (DefaultTableModel) InstrumentTable.getModel();
        ...
        excelService.addRow("infoInstrumentos", instrumento);
    ...
    private void EditButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButton1ActionPerformed
        ...
        DefaultTableModel tabla = (DefaultTableModel) InstrumentTable.getModel();
        ...
        UpdateItemDialog window = new UpdateItemDialog(null, true, new Instrument(nombre, marca, tipo, precio, stock), true);
        window.setLocationRelativeTo(this);
        window.setTitle("Actualizar Instrumento");
        window.setVisible(true);

        Instrument instrumento = window.getInstrumento();
        if (instrumento == null) {
            System.out.println("instrumento no valido");
            MessageError.setText("Datos invalidos, intente nuevamente");
            return;
        }
        ...
        excelService.updateFile("infoInstrumentos", selectedRow, instrumento);
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        if (optionSelect == JOptionPane.YES_OPTION) {
            ...
            excelService.deleteRow("infoInstrumentos", selectedRow);
        }
    ...
    private void ExcelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcelButtonActionPerformed
        MessageError.setText("");
        int totalRows = InstrumentTable.getRowCount();
        if (totalRows == 0) {
        ...
        if (selecOption == JFileChooser.APPROVE_OPTION) {
            file = new File(fileChooser.getSelectedFile() + "\\infoInstrumentos.xlsx");
        } else {
            MessageError.setText("Selecciona donde se guardara tu archivo para continuar");
            return;
        }
        excelService.exportFile(file, InstrumentTable, totalRows);
    ...
    private void changePanel() {
        Stadistics panel = new Stadistics(true, InstrumentTable);
